...
typedef enum {
    ...
    EAT_PIN27_I2C_SDA = 27,     /* GPIO, KEY_ROW, EINT, I2C_SDA */
    EAT_PIN28_I2C_SCL = 28,   /* GPIO, KEY_COL, I2C_SCL */
    ...
    EAT_PIN58_DTR = 58,      /* GPIO, KEY_ROW5, EINT */
    EAT_PIN59_DCD = 59,      /* GPIO, EINT */
    EAT_PIN60_RI = 60,     /* GPIO, KEY_COL7, EINT */
    EAT_PIN61_RTS = 61,      /* GPIO, KEY_COL3 */
    EAT_PIN62_CTS = 62,     /* GPIO, KEY_ROW, SPI_LSA ,DISP_DC */
...
typedef enum {
    ...
    EAT_PIN27_GPIO2 = 27,   /* GPIO,LSA0DA1*/
    EAT_PIN28_GPIO3 = 28,   /* GPIO,LSCK1*/
    EAT_PIN29_PCM_CLK = 29,   /* GPIO,LSRSTB,PCMCLK */
    EAT_PIN30_PCM_OUT = 30,   /* GPIO,LSDI1,PCMOUT */
    EAT_PIN31_RXD = 31,       /* UART1 */
    EAT_PIN32_TXD = 32,       /* UART1 */
    EAT_PIN33_CTS = 33,       /*GPIO,U1CTS,U2TXD,SPIMISO */
    EAT_PIN34_RTS = 34,     /*GPIO,U1RTS,U2RXD,SPIMOSI*/
    ...
    EAT_PIN65_PCM_SYNC = 65,  /* GPIO,LSCE0,PCMSYNC */
    ...
    EAT_PIN74_SCL = 74,   /* GPIO, SCL, SPISCK */
    EAT_PIN75_SDA = 75,   /* GPIO, SDA, SPICS */
...
typedef enum {
    ...
    EAT_PIN13_GPIO19 = 13,    /* GPIO,LSA0DA1*/ 
    EAT_PIN14_PCM_SYNC = 14,  /* GPIO,LSCE0,PCMSYNC */ 
...
/* SPI Bit order. */
typedef enum {
    EAT_SPI_LITTLEENDIAN, /* big endian*/
    EAT_SPI_BIGENDIAN, /* little endian*/
} EatSpiByteOrder_enum; 
...
*     EAT_FALSE The operation false.
* NOTE:
*    This interface will check params and do some error dispose,if you very care the port write speed
     you can use eat_gpio_write_ext this interface repalce it.
*****************************************************************************/
extern eat_bool (* const eat_gpio_write)(EatPinName_enum pin, EatGpioLevel_enum level);

/*****************************************************************************
* Function : eat_gpio_write_ext
* Description: Sets the level of the pin.
* Parameters:
*     pin   EatPinName_enum [IN] The pin want to set,please see EatPinName_enum.
*     level  EatGpioLevel_enum  [IN] The level want to set,please see EatGpioLevel_enum.
...
*     EAT_FALSE The operation false.
* NOTE:
*    This interface do not check params and other error dispose,if you do not care the port write speed so much,
     you can use eat_gpio_write this interface repalce it.
*****************************************************************************/
//extern eat_bool (* const eat_gpio_write_ext)(EatPinName_enum pin, EatGpioLevel_enum level);
...
*     debounce_ms   unsigned int    [IN] The debounce ,uint is 10ms,such as debounce_ms:10 means about 100ms.
...
*****************************************************************************/
extern eat_bool (* const eat_int_setup)(EatPinName_enum pin,  EatIntTrigger_enum trigger, unsigned int debounce_ms, eat_gpio_int_callback_func callback);
...
*****************************************************************************/
extern eat_bool (* const eat_int_setup_ext)(EatPinName_enum pin,  EatIntTrigger_enum trigger, unsigned int debounce_ms, eat_gpio_int_callback_func callback, eat_bool auto_invert);
...
*     wire EatSpiWire_enum [IN] Connect mode,4 wire will use PCMSYNC pin,3 wire not use,please see EatSpiWire_enum.
...
/*****************************************************************************
* Function :  eat_spi_init_with_byteorder
* Description: Initializes the SPI.
* Parameters :
*     clk  EatSpiClk_enum [IN] The freg of the GPIO3 pin,you can also turn down,please see EatSpiClk_enum. 
*     wire EatSpiWire_enum [IN] Connect mode,4 wire will use PCMSYNC pin,3 wire not use,please see EatSpiWire_enum.
...
*     enable_SDI eat_bool [IN] Whether use PCMOUT pin as SDI1.
*     enable_cs eat_bool [IN] Whether use PCMSYNC control when read or write SPI,if not,can control by APP.
*     order: little endian or big endian 0---little endian 1----big endian
* Returns:
*     EAT_TRUE  The operation Sucess.
*     EAT_FALSE The operation false.
* NOTE:
*     Nothing
*****************************************************************************/
extern eat_bool (* const eat_spi_init_with_byteorder)(EatSpiClk_enum clk, EatSpiWire_enum wire, EatSpiBit_enum bit, 
   eat_bool enable_SDI, eat_bool enable_cs,EatSpiByteOrder_enum order);
...
*     speed   u16   [IN] The Transaction speed (Kpbs).
* Returns:
...
*     Nothing
*****************************************************************************/
extern s32 (*const eat_i2c_read_only)(EAT_I2C_OWNER Owner,u8* readbuff, u16 r_len);
