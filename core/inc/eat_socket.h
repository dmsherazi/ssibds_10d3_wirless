...
/* 
 * ===  FUNCTION  ======================================================================
 *         Name: eat_soc_gettype
 *  Description: get socket type according to the socket id
 *        Input:
 *               s:: socket id
 *              
 *       Output:
 ...
 * =====================================================================================
 */
extern socket_type_enum (* const eat_soc_gettype)(s8 s);
/* 
 * ===  FUNCTION  ======================================================================
 *         Name: void
 *  Description: registe //¼Ä´æÆ÷
 *  ll back function while socket notify //Í¨Öª¡£
 *        Input:
 ...
 *        Input:e
 *               ndesc::  max selected sockt id plus 1
