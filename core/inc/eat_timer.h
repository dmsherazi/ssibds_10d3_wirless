...
* Parameters : void
* Returns:
*  unsigned int, each unit is 31.25us,from 0 to 0x1000000
*****************************************************************************/
...
/*****************************************************************************
* Function :   eat_get_current_time_in_seconds
* Description: Returns the time since the Epoch (00:00:00 UTC, January 1, 1970),measured in seconds
* Parameters : void
* Returns:
*  unsigned int, each unit is 31.25us,from 0 to 0x1000000
*****************************************************************************/
extern unsigned int (* const eat_get_current_time_in_seconds)(void);
#endif
